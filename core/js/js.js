...
if (oc_debug !== true || typeof console === "undefined" || typeof console.log === "undefined") {
  ...
  for (var i = 0; i < methods.length; i++) {
    console[methods[i]] = (function(method) {
      return function () { 
        if (window.oc_debug && typeof method == 'function') { 
...
* @return string
*/
function fileDownloadPath(dir, file, noDownload) {
  if (noDownload) {
    return OC.webroot+'/index.php/apps/files/download'+encodeURIComponent(dir).replace(/%2F/g, '/')+'/'+encodeURIComponent(file);
  } else {

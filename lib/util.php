...
class OC_Util {
	...
	*/
	...
	/**
	 * Check if the user is not restricted, redirects to home if they are
	 */
	public static function checkNotRestrictedUser() {
		if( OC_User::isRestrictedUser(OC_User::getUser())) {
			header( 'Location: '.OC_Helper::linkToAbsolute( '', 'index.php' ));
			exit();
		}
	}
